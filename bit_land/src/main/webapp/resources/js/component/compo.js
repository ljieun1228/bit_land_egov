...
compo = {
		...
		+'<div class="container">'
		+'<h2>사용자 가입</h2>'
		+'<p id = "start">Please fill in this form to create an account.</p>'
		+'<hr>'
              ...
              +'<div class="w3-row-padding">'
                ...
                +'<div class="w3-third">'
                  +'<div class="w3-white w3-text-grey w3-card-4">'
                    ...
                    +'<br>'
                      +'<img src="http://t1.daumcdn.net/section/oc/785b09689f0f401381201f6365b9b3a9" alt="Avatar" width="150px">'
		...
		cust_carousel : ()=>{
			...
			+'        <img src="http://static1.e-himart.co.kr/contents/content/display/cornerContents/imageBanner/242/imageBanner_1552626395968.jpg" alt="SAMSUNG" style="width:100%;">'
			...
			+'      <div class="item">'
			+'        <img src="http://static2.e-himart.co.kr/contents/content/display/cornerContents/imageBanner/242/imageBanner_1542588615160.jpg" alt="XIAOMI " style="width:100%;">'
			+'        <div class="carousel-caption">'
			+'          <h3>POCOPHONE-F1</h3>'
			+'        </div>'
			+'      </div>'
			...
			+'      <div class="item">'
			+'        <img src="http://static2.e-himart.co.kr/contents/content/display/cornerContents/imageBanner/242/imageBanner_1542606576270.jpg" alt="APPLE" style="width:100%;">'
			+'        <div class="carousel-caption">'
			+'          <h3>아이폰XS/Max 무약정&공기계</h3>'
			+'        </div>'
			+'      </div>'
		...
		prod_post :()=>{
			...
			+'                <input type="text" class="form-control" id="supplierName" placeholder="supplierId" value="samsung" required="">'
		...
		prod_post_aa :()=>{
            ...
            +'</div>'
	            ...
	            +'<div class="mb-3">'
	              ...
	              +'<input type="text" id="price" class="form-control" id="price"가격">'
	                +'<small class="text-muted"> 입력한 금액이 맞는지 한번더 확인하세요.</small>'
	            +'</div>'
	            +'<hr class="mb-4">'
	            +'<div class="mb-3">'
	              +'<label for="price">수 량 <span class="text-muted">(만원단위)</span></label>'
	              +'<input type="text" id="unit" class="form-control" id="price"가격">'
	                +'<small class="text-muted"> 수량을 입력하세요.</small>'
	            +'</div>'
	            +'<hr class="mb-4">'
	            +'<div class="row">'
	              +'<div class="col-md-5 mb-3">'
		...
		cust_list : ()=>{
			return '<div id="cuslist" class="container">'
			+'  <h2>사용자 리스트 </h2>'
